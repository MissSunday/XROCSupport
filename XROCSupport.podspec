...
Pod::Spec.new do |s|
  s.name             = 'XROCSupport'
  s.version          = '0.1.0'
  s.summary          = 'A short description of XROCSupport.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ext.wangxiaoran3/XROCSupport'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ext.wangxiaoran3' => 'ext.wangxiaoran3@jd.com' }
  s.source           = { :git => 'https://github.com/ext.wangxiaoran3/XROCSupport.git', :tag => s.version.to_s }
