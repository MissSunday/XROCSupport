...
-(void)createItemWithDict:(NSDictionary *)dict {
    ...
    XRBaseNavigationController * viewController = [[XRBaseNavigationController alloc] initWithRootViewController:[[cls alloc] init]];
    ...
    [viewController.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor orangeColor]} forState:UIControlStateNormal];
