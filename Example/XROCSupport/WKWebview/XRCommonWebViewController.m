//
//  XRCommonWebViewController.m
//  XRLookingForHouseAPP
//
...
#import "XRCommonWebViewController.h"
#import "XRCommonWebViewCustomNav.h"
#import "XRWeakWebViewScriptMessageDelegate.h"


@interface XRCommonWebViewController ()<WKNavigationDelegate,WKUIDelegate,WKScriptMessageHandler>

@property (nonatomic, strong)UIProgressView *progressView;

@property(nonatomic,strong)XRCommonWebViewCustomNav *nav;

@end

@implementation XRCommonWebViewController
...
- (WKWebView *)webView{
    if (!_webView) {
        ...
        XRWeakWebViewScriptMessageDelegate *weakScriptMessageDelegate = [[XRWeakWebViewScriptMessageDelegate alloc] initWithDelegate:self];
...
- (XRCommonWebViewCustomNav *)nav{
    if (!_nav) {
        _nav = [[XRCommonWebViewCustomNav alloc]init];
